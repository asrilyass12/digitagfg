...
<html lang="en">
  ...
  <body dir="rtl">
    ...
    <!-- login -->
        <div class="login container p-4 my-md-5" dir="ltr" id="register">
        <div class="row justify-content-center" style="margin-top: 35px;">
            <div class="login_welcom col-md-5" style="z-index: 1; background-color: #fffbf523;">
                ...
                <h1 class="rounded-pill text-primary  p-2">
                    <h2 class="text-white d-flex justify-content-center">! مرحبا بك</h2>
                </h1>
            </div>
                    ...
                    <div class="card-body">
                        <form onsubmit="event.preventDefault()" class="box">
                            <div class="text-center">
                                ...
                                <h3 class="my-2 text-secondary" style="font-size: 30px;">التسجيل</h3>
                            </div>
                            <input class="my-2" type="text" name="" placeholder="Username" />
                            <input class="my-4" type="text" name="" placeholder="E-mail" />
                            <input type="password" name="" placeholder="Password" />
                            <input type="password" name="" placeholder="Cnferm Password" />
                            <input type="submit" name="" value="التسجيل" onclick="showSwal('success-message')"/>
                            <div class="col-md-12">
