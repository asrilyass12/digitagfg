    ...
    <div class="container-xxl p-0">
      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <a
            href="#login"
            class="btn rounded-3 py-1 px-3 ms-2 d-none d-lg-block"
            >دخول</a
          >
          <a
            href="register.html"
      ...
      <div class="login container p-4 my-md-5" dir="ltr" id="login">
        <div class="row justify-content-center" style="margin-top: 35px">
          <div
            class="login_welcom col-md-5"
            style="z-index: 1; background-color: #fffbf523"
          >
            <img
              src="https://ajicod.com/media/img/log.png"
              class="mw-100"
              alt=""
              srcset=""
            />
            <h1 class="rounded-pill text-primary p-2">
              <h2 class="text-white d-flex justify-content-center">
                ! مرحبا بعودتك
              </h2>
            </h1>
          </div>
              ...
              <div class="card-body">
                <form onsubmit="event.preventDefault()" class="box">
                  <div class="text-center">
                    <img
                      src="img/أبطال الديجيتال.png"
                      style="width: 100px"
                      class="my-3"
                      alt="logo"
                    />
                    <h3 class="my-2 text-secondary" style="font-size: 30px">
                      الدخول
                    </h3>
                  </div>
                  <input
                  ...
                  <a class="forgot text-muted" href="#">نسيتي كلمة السر؟</a>
      ...
      <div
        class="container-fluid text-light footers wow fadeIn"
        data-wow-delay="0.1s"
        dir="rtl"
      >
        <div class="container py-5 px-lg-5">
          <div class="row g-5">
            <div class="col-md-4 col-lg-3">
              ...
              <p>
                <i class="fa fa-map-marker-alt me-3"></i> الثانوية الإعدادية
                علال الفاسي
              </p>
            ...
            <div class="col-md-6 col-lg-3">
              <p class="section-title text-white h5 mb-4">
                <strong>نادي أبطال الديجيتال</strong><span></span>
              </p>
              <p>
                الهدف هو اننا نحاولو نكتشفو المواهب المعلوماتية و نطوروها بشكل
                أفضل كما اننا غادي نحرصو على اندماجكم باش ينجح هاد الكلوب
              </p>
            </div>
            <div class="col-md-6 col-lg-3">
